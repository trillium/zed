...
//!
//! Extensions can use decorations for:
//! - **Before/After content**: SVG or text overlays positioned relative to characters
//! - **Range highlights**: Background color highlights for visual feedback
//! - **Whole-line highlights**: Full-width line highlighting
//!
...
pub enum DecorationType {
    ...
    ///
    /// SVG shapes or text positioned before characters using negative margins
    /// to create visual overlays.
    Before,
    ...
    ///
    /// Used for temporary flash effects, persistent highlights, and other
    /// range-based visual feedback.
    Range,

    /// Highlight applied to entire lines.
    ///
    /// Similar to Range but always extends to full line width.
    WholeLine,
}
...
pub enum DecorationContent {
    ...
    ///
    /// Accepts SVG data URIs like `data:image/svg+xml;utf8,<svg>...</svg>`
    /// or base64-encoded variants.
    ///
...
pub enum DecorationRangeBehavior {
    ...
    ///
    /// Prevents the decoration from expanding when text is inserted at
    /// boundaries. This is the default behavior.
    ClosedClosed,
}
...
mod tests {
    ...
    #[test]
    #[test]
    fn test_svg_hat_decoration_example() {
    ...
    #[test]
    fn test_flash_highlight_decoration_example() {
    ...
    #[test]
    fn test_scope_visualizer_decoration_example() {
